 ...
 */
public class InterestsAdapter extends RecyclerView.Adapter<InterestsAdapter.SimpleItemVH> {

	private List<Interest> items;
	private OnItemClickListener listener;

	public InterestsAdapter(List<Interest> items, OnItemClickListener listener) {
		this.items = items;
	...
	@NonNull
	@Override
	public InterestsAdapter.SimpleItemVH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
		return new SimpleItemVH(LayoutInflater.from(parent.getContext())
				.inflate(R.layout.item_profile_contact, parent, false));
	}

	@Override
	public void onBindViewHolder(@NonNull InterestsAdapter.SimpleItemVH holder, int position) {
