 ...
 */
public class BrowseInterestsAdapter extends RecyclerView.Adapter<BrowseInterestsAdapter.SimpleItemVH> {

	private List<Interest> items;
	private OnItemClickListener listener;

	BrowseInterestsAdapter(List<Interest> items, OnItemClickListener listener) {
		this.items = items;
	...
	@NonNull
	@Override
	public BrowseInterestsAdapter.SimpleItemVH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
		return new SimpleItemVH(LayoutInflater.from(parent.getContext())
				.inflate(R.layout.item_profile_contact, parent, false));
	}

	@Override
	public void onBindViewHolder(@NonNull BrowseInterestsAdapter.SimpleItemVH holder, int position) {
